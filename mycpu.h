...
enum regs {regA,regB,regC,regD,regF,regH,regL,regCB,regDA,regHL,regSP,regX,regY,regx,regVAL };
#define NUM_REG 14
#define NUM_16_REG 7
struct registers {
 	char *name; 
 ...
 struct registers r[NUM_REG+1] = { 
	...
	"x",16,regx,preg,
	 "VAL",-1,regVAL,number };
#define NUMBEROPS  39 
#define NUMBERINST  237 
enum instr {HLT,NOP,POP,MOV,PUSHALL,POPALL,DEC,INC,ADC,ADD,ST,AND,SLL,SLR,OR,LD,SUB,CMP,PUSH,CALL,JMP,JNEQ,JPZ,JNZ,JLT,JGT,JEQ,JPC,JNEG,JPOS,RETI,RET,XOR,NOT,SET,CLR,SBC,OUT,IN,inst_end };
char *a_inst[NUMBEROPS+1] = {"HLT","NOP","POP","MOV","PUSHALL","POPALL","DEC","INC","ADC","ADD","ST","AND","SLL","SLR","OR","LD","SUB","CMP","PUSH","CALL","JMP","JNEQ","JPZ","JNZ","JLT","JGT","JEQ","JPC","JNEG","JPOS","RETI","RET","XOR","NOT","SET","CLR","SBC","OUT","IN","inst_end" };
struct op_code {
	 int inst; 
	 int size;
	 int opcode;
...
struct op_code op_codes[NUMBERINST+1] = {
	...
	ADC,0,232,regD,reg,regL,reg,2,
	ADC,0,233,regD,reg,regH,reg,2,
	...
	ADD,0,230,regD,reg,regL,reg,2,
	ADD,0,231,regD,reg,regH,reg,2,
	...
	ST,0,240,regHL,reg,regY,preg,2,
	ST,0,241,regHL,reg,regX,preg,2,
	ST,0,242,regCB,reg,regY,preg,2,
	ST,0,243,regCB,reg,regX,preg,2,
	ST,0,244,regDA,reg,regX,preg,2,
	ST,0,245,regDA,reg,regY,preg,2,
	...
	LD,0,246,regDA,reg,regY,preg,2,
	LD,0,247,regDA,reg,regX,preg,2,
	LD,0,248,regCB,reg,regY,preg,2,
	LD,0,249,regCB,reg,regX,preg,2,
	...
	SUB,0,173,regDA,reg,regCB,reg,2,
	...
	OUT,0,250,regA,reg,none,none,1,
	IN,0,251,regA,reg,none,none,1,
